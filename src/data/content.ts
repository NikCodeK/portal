import bsfzRegistrierungContent from '../content/bsfz-registrierung.md?raw';
import bsfzSiegelContent from '../content/bsfz-siegel.md?raw';
import foerderquoteContent from '../content/foerderquote.md?raw';
import fzlIntroContent from '../content/fzl-intro.md?raw';
import grafikbriefingContent from '../content/grafikbriefing.md?raw';
import inhaltlichesBeispielprojektContent from '../content/inhaltliches-beispielprojekt.md?raw';
import nichtFoerderfaehigContent from '../content/nicht-foerderfaehig.md?raw';
import projektprofilContent from '../content/projektprofil-dokument.md?raw';
import unternehmenInSchwierigkeitenContent from '../content/unternehmen-in-schwierigkeiten.md?raw';
import verbundunternehmenContent from '../content/verbundunternehmen.md?raw';
import zeitablaufContent from '../content/zeitablauf.md?raw';
    ...
    cards: [
      {
        ...
        detailContent: unternehmenInSchwierigkeitenContent,
      },
      {
        ...
        detailContent: verbundunternehmenContent,
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        detailContent: bsfzRegistrierungContent,
      },
      {
        id: 'fzl-intro',
        badge: 'Information vor Antrag',
      ...
      },
      {
        ...
        detailContent: nichtFoerderfaehigContent,
      },
      {
        id: 'foerderquote',
        badge: 'Information vor Antrag',
        ...
        detailContent: foerderquoteContent,
      },
      {
        id: 'grafikbriefing',
        badge: 'Information vor Antrag',
        ...
        detailContent: grafikbriefingContent,
      },
      {
        ...
        detailContent: inhaltlichesBeispielprojektContent,
      },
      {
        ...
        detailContent: projektprofilContent,
      },
      {
        id: 'zeitablauf',
        badge: 'Information vor Antrag',
        ...
        detailContent: zeitablaufContent,
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        detailContent: bsfzSiegelContent,
      },
    ],
  },
  {
